# Generated by Powerlevel10k configuration wizard on 2024-04-28 at 02:10 CEST.
...
# angled separators, sharp heads, flat tails, 2 lines, dotted, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_BACKGROUND=$C_Mantle
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%K{#1e2030}\uE0B0'
  # The left end of right prompt.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%K{#1e2030}\uE0B2'
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=$C_Sapphire
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=$C_Crust
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$C_Green
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$C_Red
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=$C_Mauve
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$C_Base
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$C_Surface1
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$C_Crust
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$C_Text
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=$C_Crust
